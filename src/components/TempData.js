var tempGameData = [
    {
        name: "Yakuza 0",
        cover: {
            url: "https://images.igdb.com/igdb/image/upload/t_thumb/co252x.jpg"
        },
    ...
    { 
        ...
        cover: {
            url: "https://images.igdb.com/igdb/image/upload/t_thumb/co6z12.jpg"
        },
    ...
    { 
        ...
        cover: {
            url: "https://images.igdb.com/igdb/image/upload/t_thumb/co7ds7.jpg"
        },
    ...
    { 
        name: "Elden Ring",
        cover: {
            url: "https://images.igdb.com/igdb/image/upload/t_thumb/co4jni.jpg"
        },
    ...
    { 
        ...
        cover: {
            url: "https://images.igdb.com/igdb/image/upload/t_thumb/co2e1l.png"
        },
    ...
    { 
        ...
        cover: {
            url: "https://images.igdb.com/igdb/image/upload/t_thumb/co53m8.png"
        },
        description: "Dive into the Dark Hour and awaken the depths of your heart. Persona 3 Reload is a captivating reimagining of the genre-defining RPG, reborn for the modern era with cutting-edge graphics and gameplay.",
        avgScore: 6,
        userScore: 3,
    ...
    { 
        name: "Doom Eternal",
        cover: {
            url: "https://images.igdb.com/igdb/image/upload/t_thumb/co3p5n.webp"
        },
